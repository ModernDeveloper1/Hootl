...
interface YesManInterface extends ethers.utils.Interface {
  functions: {
...
export class YesMan extends BaseContract {
  ...
  callStatic: {
    airdrop(_addresses: string[], overrides?: CallOverrides): Promise<void>;
