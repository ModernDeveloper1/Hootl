...
interface YesMannInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setWhitelistException(address)": FunctionFragment;
    ...
    "whitelistException(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setWhitelistException",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "whitelistException",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class YesMann extends BaseContract {
  ...
  whitelistException(arg0: string, overrides?: CallOverrides): Promise<boolean>;
